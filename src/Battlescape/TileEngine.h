...
public:
	...
	/// Runs a wall-aware diffusion pass over each light layer's per-corner accumulator so skylight bleeds through openings into interiors and shadow edges stay soft. Only active when oxceBattleRealisticLighting is on.
	void bloomLighting();
